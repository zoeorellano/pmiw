...
function decisiones() {
    ...
    if (pantallaActual == 6) { /*PANTALLA 3A: LA LUZ*/
        ...
        dibujarBoton(410, 400, "Abrir nodo");
        ...
        dibujarBoton(350, 430, "Solicitar acceso a su servidor oculto");

    } if (pantallaActual == 16) { /*PANTALLA 6B: VOCES CONTRADICTORIAS*/
        dibujarBoton(350, 400, "Seguir a los que prometen libertad");
        dibujarBoton(350, 430, "Seguir a los que advierten peligro");
        ...
        dibujarBoton(420, 400, "Reconstruir el patrón");
        dibujarBoton(400, 430, "Intentar romper el cuaderno");

    } if (pantallaActual == 19) { /*PANTALLA 7A: CAMINO DE EXPANSIÓN*/
        dibujarBoton(420, 400, "Aceptar la invitación");
        dibujarBoton(415, 430, "Exigir saber el precio");

    } if (pantallaActual == 20) { /*PANTALLA 7B: NODO PROHIBIDO*/
        dibujarBoton(390, 400, "Investigar la cámara invisible");
        ...
        dibujarBoton(490, 430, "Desafiarlo");

    } if (pantallaActual == 23) { /*PANTALLA 8B: EL DOBLE*/
        dibujarBoton(400, 400, "Aceptar que ella soy yo");
        dibujarBoton(420, 430, "Negarla con fuerza");
        ...
        dibujarBoton(460, 440, "Borrarme para siempre");
        ...
        dibujarBoton(400, 400, "Ver Creditos");
...
function mousePressed() {
    ...
    if (pantallaActual == 2) {
        if (botonClick(300, 100, "Comenzar")) { // "Comenzar" -> EL MENSAJE
            pantallaActual = 3;
    ...
    if (pantallaActual == 7) {
        if (botonClick(410, 400, "Abrir nodo")) { // "Abrir nodo" -> 4A
            pantallaActual = 8;
            return;
        }
        if (botonClick(400, 430, "Guardar información")) { // "Guardar información" -> 4C
            pantallaActual = 10;
            return;
        }
    }
    ...
    if (pantallaActual == 9) {
        if (botonClick(420, 400, "Entrar completamente")) { // "Entrar completamente" -> 5A
            pantallaActual = 11;
            return;
        }
        if (botonClick(400, 430, "Retirar la mano...")) { // "Retirar la mano..." -> 5C
            pantallaActual = 13;
            return;
        }
    }
    ...
    if (pantallaActual == 10) {
        if (botonClick(410, 400, "Anotar el nodo...")) { // "Anotar el nodo..." -> 5C
            pantallaActual = 13;
            return;
        }
        if (botonClick(400, 430, "Dormir...")) { // "Dormir..." -> 5D
            pantallaActual = 14;
            return;
        }
    }
    ...
    if (pantallaActual == 11) {
        ...
        if (botonClick(400, 430, "Pedir pruebas...")) { // "Pedir pruebas..." -> 6B
            pantallaActual = 16;
            return;
        }
    }
    ...
    if (pantallaActual == 13) {
        if (botonClick(460, 400, "Revisar el teléfono")) { // "Revisar el teléfono" -> 6C
            pantallaActual = 17;
            return;
        }
        if (botonClick(400, 430, "Anotar los símbolos...")) { // "Anotar los símbolos..." -> 6D
            pantallaActual = 18;
            return;
        }
    }
    ...
    if (pantallaActual == 14) {
        if (botonClick(400, 400, "Seguir los códigos")) { // "Seguir los códigos" -> 6A
            pantallaActual = 15;
            return;
        }
        if (botonClick(400, 430, "Romper el sueño")) { // "Romper el sueño" -> 6C
            pantallaActual = 17;
            return;
        }
    }
    ...
    if (pantallaActual == 15) {
        ...
        if (botonClick(350, 430, "Solicitar acceso...")) { // "Solicitar acceso..." -> 7B
            pantallaActual = 20;
            return;
        }
    }
    ...
    if (pantallaActual == 16) {
        if (botonClick(350, 400, "Seguir a los que prometen libertad")) { // "Seguir a los que prometen libertad" -> 7A
            pantallaActual = 19;
            return;
        }
        if (botonClick(350, 430, "Seguir a los que advierten peligro")) { // "Seguir a los que advierten peligro" -> 7C
            pantallaActual = 21;
            return;
        }
    }
    ...
    if (pantallaActual == 17) {
        ...
        if (botonClick(400, 430, "Dibujarla...")) { // "Dibujarla..." -> 7C
            pantallaActual = 21;
            return;
        }
    }
    ...
    if (pantallaActual == 18) {
        if (botonClick(420, 400, "Reconstruir el patrón")) { // "Reconstruir el patrón" -> 7C
            pantallaActual = 21;
            return;
        }
    ...
    if (pantallaActual == 19) {
        if (botonClick(420, 400, "Aceptar la invitación")) { // "Aceptar la invitación" -> 8A
            pantallaActual = 22;
            return;
        }
        if (botonClick(415, 430, "Exigir saber el precio")) { // "Exigir saber el precio" -> 8B
            pantallaActual = 23;
            return;
        }
    }
    ...
    if (pantallaActual == 20) {
        if (botonClick(390, 400, "Investigar la cámara invisible")) { // "Investigar la cámara invisible" -> 8B
            pantallaActual = 23;
            return;
        }
    ...
    if (pantallaActual == 21) {
        ...
        if (botonClick(400, 430, "Silenciarlo...")) { // "Silenciarlo..." -> 8C
            pantallaActual = 24;
            return;
        }
    }
    ...
    if (pantallaActual == 22) {
        ...
        if (botonClick(490, 430, "Desafiarlo")) { // "Desafiarlo" -> 9B
            pantallaActual = 26;
            return;
        }
    }
    ...
    if (pantallaActual == 23) {
        if (botonClick(400, 400, "Aceptar que ella soy yo")) { // "Aceptar que ella soy yo" -> 9A
            pantallaActual = 25;
            return;
        }
        if (botonClick(420, 430, "Negarla con fuerza")) { // "Negarla con fuerza" -> 9B
            pantallaActual = 26;
            return;
        }
    }
    ...
    if (pantallaActual == 24) {
        ...
        if (botonClick(400, 430, "Seguir las voces una última vez")) { // "Seguir las voces una última vez" -> 9A
            pantallaActual = 25;
            return;
        }
    }
    ...
    if (pantallaActual == 25) {
        ...
        if (botonClick(460, 440, "Borrarme para siempre")) { // "Borrarme para siempre" -> Final Nada
            pantallaActual = 29;
            return;
        }
    }
    ...
    if (pantallaActual == 26) {
        if (botonClick(500, 370, "Ser todos")) { // "Ser todos" -> Final Divinidad
            pantallaActual = 27;
            return;
        }
        if (botonClick(400, 400, "Ser alguien")) { // "Ser alguien" -> Final Humano
            pantallaActual = 28;
            return;
        }
        if (botonClick(250, 430, "No ser")) { // "No ser" -> Final Nada
            pantallaActual = 29;
            return;
        }
    }
    if (pantallaActual == 30) {
        if (botonClick(400, 400, "Ver Creditos")) { // "Ver Creditos"
            pantallaActual = 33;
    ...
    if (pantallaActual == 31) {
        if (botonClick(400, 400, "Ver Creditos")) { // "Creditos"
            pantallaActual = 33;
